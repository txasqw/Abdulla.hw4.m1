...
public class Main {
    ...
    public static int[] heroesHealth = {300, 280, 270, 240,360,255,220,210};
    public static int[] heroesDamage = {20, 15, 10, 0, 5,10,15,20};
        ...
        if (heroesHealth[4]> 0 && bossHealth > 0){
            switch (randomDamage){
                case 1:
                    ...
                    System.out.println(" Витчер нанесет критический урон " );
                    System.out.println(" Урон Витчер увеличен на " + randomHit);
                    break;
                case 2:
                    bossDamage = 50;
                    break;
